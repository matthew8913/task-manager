 ...
 * Проверяет наличие и валидность JWT, а также устанавливает аутентификацию в контекст безопасности.
 */
@Component
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    /**
     * Основной метод фильтрации запросов. Извлекает JWT из заголовка,
     * проверяет его валидность и устанавливает аутентификацию в контекст безопасности.
     *
